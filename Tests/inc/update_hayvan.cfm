...
<input type="hidden" name="HAYVAN_ID" value="<cfoutput>#attributes.iid#</cfoutput>">
    <cf_tab defaultOpen="sayfa_1" divId="sayfa_1,sayfa_2,sayfa_3,sayfa_4,sayfa_5" divLang="Genel Bilgiler;Tohumlama- Gebelik;Süt Verim;Kontrol;Tedavi">
                            ...
                            <select>
                                <cfoutput query="GetAnimalTypes" group="PRODUCT_ID">
                                    <optgroup label="#PRODUCT_NAME#">
                                        <cfoutput>
                                            <option value="#PRODUCT_ID#-#STOCK_ID#">#PROPERTY#</option>
                                        </cfoutput>
                                    </optgroup>
                                </cfoutput>
                            </select>
