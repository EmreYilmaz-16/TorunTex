...
<cfquery name="CREATE_SEPET" datasource="#DSN3#" result="RES">
    INSERT INTO SEVKIYAT_SEPET_PBS(SEVK_NO,DEPARTMENT_ID,LOCATION_ID,ORDER_ID,RECORD_DATE,RECORD_EPM ) VALUES ('#SEPET_NO#',#DEPARTMENT_ID#,#LOCATION_ID#,#ORDER_ID#,GETDATE(),#session.ep.userid#)
</cfquery>
