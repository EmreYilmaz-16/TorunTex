...
LEFT JOIN #DSN3#.PRICE AS P ON P.PRICE_CATID = CC.PRICE_CAT  AND PU.PRODUCT_UNIT_ID=P.UNIT
...
<cfloop query="getCekiListesi">
    ...
    <cfif len(WRK_ROW_ID)>
    <cfset "attributes.pbs_relation_id#IX#"=WRK_ROW_ID>
    <cfelse>
        <cfset "attributes.pbs_relation_id#IX#"='NotOrdered'>
</cfif>
