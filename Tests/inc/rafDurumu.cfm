<cfquery name="getrafd" datasource="#dsn3#">
    select SHELF_CODE,TTL.*,PRODUCT_PLACE.STORE_ID,PRODUCT_PLACE.LOCATION_ID from w3Toruntex_1.PRODUCT_PLACE 
...
WHERE 1=1  
UNION ALL
SELECT  -1* ISNULL(AMOUNT,0)AMOUNT,-1* ISNULL(AMOUNT2,0)AMOUNT2,CONVERT(DECIMAL(18,2),ISNULL(AMOUNT,0)/ISNULL(AMOUNT2,1)) AS CV,UNIT,UNIT2,LOT_NO,STOCK_ID,S.PROJECT_ID PROJECT_ID,SHELF_NUMBER FROM w3Toruntex_2023_1.STOCK_FIS_ROW 
