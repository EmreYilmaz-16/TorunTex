...
LEFT JOIN ( 
SELECT PROCESS_CAT PI1,FIS_TYPE AS PROCESS_TYPE,0 AS PS,FIS_ID FROM	w3Toruntex_2023_1.STOCK_FIS 
UNION ALL 
SELECT PROCESS_CAT PI1,SHIP_TYPE AS PROCESS_TYPE ,1 AS PS,SHIP_ID AS FIS_ID FROM	w3Toruntex_2023_1.SHIP 
) AS SF
