...
LEFT JOIN w3Toruntex.STOCKS_LOCATION AS SL ON SL.DEPARTMENT_ID = O.DELIVER_DEPT_ID
	AND SL.LOCATION_ID = O.LOCATION_ID
LEFT JOIN w3Toruntex.DEPARTMENT AS D ON D.DEPARTMENT_ID = O.DELIVER_DEPT_ID
