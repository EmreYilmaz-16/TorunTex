...
LEFT JOIN (
	select SR.PLATE,SR.NOTE,SR.ASSETP,SR.IS_TYPE,SSR.DELIVER_TYPE,SSR.SHIP_NUMBER,SSR.SHIP_ID from w3Toruntex_2023_1.SHIP_RESULT_ROW AS SSR
INNER JOIN w3Toruntex_2023_1.SHIP_RESULT AS SR ON SSR.SHIP_RESULT_ID=SR.SHIP_RESULT_ID
WHERE IS_TYPE=2
