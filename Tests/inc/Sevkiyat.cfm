...
WHERE O.DELIVER_DEPT_ID = #DEPARTMENT_ID#
	...
	AND ORDER_STAGE not IN(262,259)
            ...
            <option value="#getDoluDepolar.DEPARTMENT_ID#-#getDoluDepolar.LOCATION_ID#*#getOrder.ORDER_ID#*#getOrder.SEPET_ID#"> #dateformat(getOrder.DELIVERDATE,"dd/mm/yyyy")# - #getDoluDepolar.COMMENT# #getOrder.NICKNAME# #getOrder.COUNTRY_NAME# #getOrder.PLAKA# #getOrder.KONTEYNER# </option>
		</cfloop>
        </cfoutput>
    </select>
