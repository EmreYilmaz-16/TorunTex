...
<cf_box title="Depo - Lokasyon" scroll="1" collapsable="1" resize="1" popup_box="1">
    ...
    <cfoutput query="gets">
        ...
        <li <cfif (BAKIYE gte 0 AND SIP_DURUM EQ 0) or attributes.all eq 1>  onclick="send_value_1('#LOCATION_ID#█#DEPARTMENT_HEAD# - #COMMENT#█#DEPARTMENT_ID#█#BRANCH_ID#');"<CFELSE>style="color:red" </cfif>>
            <a href="javascript://">
