...
SELECT AMOUNT,AMOUNT2,CONVERT(DECIMAL(18,2),AMOUNT/AMOUNT2) AS CV,UNIT,UNIT2,LOT_NO,STOCK_ID,ROW_PROJECT_ID PROJECT_ID FROM w3Toruntex_2023_1.SHIP_ROW  
WHERE 1=1 AND ISNULL(SHELF_NUMBER,TO_SHELF_NUMBER)=#getS2.PRODUCT_PLACE_ID#  AND 
UNION ALL
SELECT  -1* AMOUNT,-1* AMOUNT2,CONVERT(DECIMAL(18,2),AMOUNT/AMOUNT2) AS CV,UNIT,UNIT2,LOT_NO,STOCK_ID,S.PROJECT_ID PROJECT_ID FROM w3Toruntex_2023_1.STOCK_FIS_ROW 
