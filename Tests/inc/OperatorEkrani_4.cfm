...
<div class="row" >
    <div class="col col-10">
        <button class="navbar-toggler" onclick="$('#col_0001').toggle(500)" id="BtnORk">≡</button>
    </div>
    <div class="col col-2">
        <table style="width: 100%;">
            <tbody>
                <tr>   
                    <td>
                        <button class="btn btn-sm btn-outline-dark" id="Location">
...
<script src="/AddOns/Partner/js/Operator_4.js"></script>
