...
<cfoutput query="PROJECT">
    ...
    <cfquery name="S1" datasource="#DSN#">  
        SELECT AMOUNT,INVOICE_ID   FROM PROJECT_INVOICE_RELATIONSXXXXXX  LEFT JOIN FATURAXXXXXX ON FATURAXXXXXX.INVOICE_ID=PROJECT_INVOICE_RELATIONSXXXXXX.INVOICE_ID
