...
//var SepetId=1;
//var User_ID=12;
var Res=wrk_query("SELECT SRR.LOT_NO,SRR.SEPET_ROW_ID,SSR.AMOUNT,SSR.PRODUCT_ID,S.PRODUCT_NAME FROM SEVKIYAT_SEPET_ROW_READ_PBS AS SRR INNER JOIN SEVKIYAT_SEPET_ROW_PBS AS  SSR ON SSR.SEPET_ROW_ID=SRR.SEPET_ROW_ID INNER JOIN STOCKS AS S ON S.PRODUCT_ID=SSR.PRODUCT_ID  WHERE SRR.LOT_NO='"+LotNo+"' AND SSR.SEPET_ID="+SEPET_ID,"DSN3");
