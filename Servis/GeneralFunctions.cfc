<cfcomponent>
    <cffunction name="SaveFatFis" access="remote" httpMethod="Post" returntype="any" returnFormat="json">
        <cfquery name="INS" datasource="#arguments.DSN3#" result="RES">
            INSERT INTO  STOK_FIS_FATURA(FIS_ID,STOCK_ID,FATURA_ID,AMOUNT,RECORD_DATE,RECORD_EMP,FIS_PERIOD_ID) VALUES(#arguments.FIS_ID#,#arguments.STOCK_ID#,#arguments.INVOICE_ID#,#arguments.AMOUNT#,GETDATE(),#arguments.EMPLOYEE_ID#,#arguments.PERIOD_ID#)
        </cfquery>
