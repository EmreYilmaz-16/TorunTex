...
<CFELSE>
    <cfquery name="GETD" datasource="#DSN2#">
        SELECT '#O.ARGSSS.LOT_NUMARASI#' LOT_NO,#O.ARGSSS.AMOUNT# AMOUNT,S.PRODUCT_NAME,S.PRODUCT_DETAIL,S.PRODUCT_CODE_2,SL.COMMENT,'' AS ORDER_NUMBER FROM STOCKS AS S 
